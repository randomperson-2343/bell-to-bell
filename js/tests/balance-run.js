...
vm.runInContext(`
  ...
  B.UI = new Proxy({}, { get: () => () => {} });
`, ctx);
['js/modes/story/story-data.js', 'js/modes/story/patch3-data.js', 'js/modes/story/sqwak-story.js', 'js/modes/story/endings.js', 'js/modes/story/patch3-endings.js', 'js/modes/story/story-engine.js'].forEach(run);
